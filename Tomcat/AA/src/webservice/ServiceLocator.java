...
public class ServiceLocator extends org.apache.axis.client.Service implements webservice.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://10.0.106.239:81/aabo/Service.asmx";
    ...
    public webservice.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public webservice.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservice.ServiceSoapStub _stub = new webservice.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservice.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                webservice.ServiceSoapStub _stub = new webservice.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
