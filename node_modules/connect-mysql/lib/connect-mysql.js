...
module.exports = function (connect) {
    ...
    function MySQLStore(options) {
        ...
        this.query(function(connection, done) {
            connection.query('CREATE TABLE IF NOT EXISTS `' + TableName + '` (`sid` VARCHAR(255) NOT NULL, `session` TEXT NOT NULL, `expires` INT, PRIMARY KEY (`sid`) ) CHARACTER SET utf8 COLLATE utf8_unicode_ci engine=ndb', function (err) {
                if (err) done(err);
                else if (cleanup) {
